...
public:
	...
	bool Blit(SDL_Texture* texture, float x, float y, const SDL_Rect* section = NULL, float scale = 1, float speed = 1.0f, double angle = 0, int pivot_x = INT_MAX, int pivot_y = INT_MAX, SDL_RendererFlip flip = SDL_FLIP_NONE);
